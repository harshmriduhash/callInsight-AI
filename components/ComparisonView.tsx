...
export default function ComparisonView({ recordings }: ComparisonViewProps) {
  ...
  const avgSentiment =
    comparisonData.reduce((sum, r) => sum + r.sentiment, 0) /
      comparisonData.length || 0;
  const avgEngagement =
    comparisonData.reduce((sum, r) => sum + r.engagement, 0) /
      comparisonData.length || 0;
    ...
    <div className="space-y-6">
      <div className="glass rounded-xl p-6">
        ...
        <p className="text-gray-300 mb-6">
          Selecione até 5 gravações para comparar lado a lado
        </p>
          ...
          {recordings.map((recording) => (
            ...
            >
              ...
              <div className="text-xs text-gray-400">
                Sentimento:{" "}
                {(
                  (recording.aiData?.sentiment || recording.sentiment || 0) *
                  100
                ).toFixed(0)}
                %
              </div>
              <div className="text-xs text-gray-400">
                Engajamento:{" "}
                {(
                  (recording.aiData?.engagement || recording.engagement || 0) *
                  100
                ).toFixed(0)}
                %
              </div>
        ...
        <>
          ...
          <div className="glass rounded-xl p-6">
            <h3 className="text-xl font-bold mb-4">
              Comparação de Sentimento e Engajamento
            </h3>
